...
\begin{center}
  \begin{tikzpicture}[scale=1.5]
    ...
    \filldraw[red]  (1.5,1.5) circle (2pt) node[below] {$P(i,j)$};
    \filldraw[blue] (2.5,1.5) circle (2pt) node[below]  {$E(i+1,j)$};
    \filldraw[blue] (1.5,2.5) circle (2pt) node[above] {$N(i,j+1)$};
    \filldraw[blue] (0.5,1.5) circle (2pt) node[below]  {$W(i-1,j)$};
    \filldraw[blue] (1.5,0.5) circle (2pt) node[below] {$(i,j-1)$};
